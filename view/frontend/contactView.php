...
<?php
    ...
    $emailTo = "tristancien@live.fr";
        ...
        $array["username"] = test_input("username");
        $array["email"] = test_input("email");
        $array["phone"] = test_input("phone");
        $array["website"] = test_input("website");
        $array["sujet"] = test_input("sujet");
        $array["message_contact"] = test_input("message_contact");
