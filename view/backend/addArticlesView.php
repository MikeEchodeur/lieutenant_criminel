...
<p>Gestion des articles :</p>
	...
	{ 
		...
		while ($data = $req->fetch())
		{
			...
			<form method="post" enctype="multipart/form-data">
				...
				<input type="file" name="fileselect" id="fileselect" value="C:/MAMP/htdocs/lieutenant_criminel/public/image/article/DarKvador.jpg" accept="image/*"/><br />
	...
	{ ?>
		<form method="post" enctype="multipart/form-data">
			<label for="fileselect">Image liée à l'article : </label>
